...
export const metadata = {
  ...
  keyworkds: 'dj, music, event planning, party, rentals, photobooth,request a song, lighting, speaker, sound system rental, cheap dj services', // Keywords for SEO purposes
  ...
  return (
    <html lang="en">
       ...
       <Head>
        ...
        <meta name="description" content="BlackTie Events - Your Event Planning Partner" />
      </Head>
